<?
  ...
  if ((isset($_POST['email'])) && ($_POST['email'] != '') && 
    ...
    $registered2 = 'Artimiausiu metu su jumis susisieksime dėl galimybės pirmiau nei kiti išbandyti naują e.sviesa.lt svetainės versiją.';
  ...
  <div class="wrapper">
    ...
    <div class="row register">
      <div class="column-8">
        ...
        <div class="paragraph" style="<?php print $textas2; ?>">
          <?php print $registered2; ?>
        </div>
      ...
      <div class="column-4" style="<?php print $forma; ?>">
        <form method="post">
